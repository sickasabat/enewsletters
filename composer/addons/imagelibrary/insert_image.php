...
<!--
<tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;">Link to:</td>
	<td style="padding-bottom: 2px; padding-top: 0px;"><input type="text" name="link" id="link" value=""  style="font-size: 10px; width: 100%;"></td>
 </tr>
/-->
</table>	
